...
public class GameplayFunctions : MonoBehaviour
{
    ...
    public TMP_Text ScrollingLightsButton;
    ...
    public void ToggleScrollingLights()
    {
        bool EnableScrollingLights = System.Convert.ToBoolean((Settings.Get("Enable Scrolling Lights", true).ToString()));
        Settings.Set("Enable Scrolling Lights", !EnableScrollingLights);
    }
    ...
    public void RefreshUI()
    {
        ...
        bool EnableScrollingLights = System.Convert.ToBoolean((Settings.Get("Enable Scrolling Lights", true).ToString()));
        ScrollingLightsButton.text = $"Scrolling Lights: {((EnableScrollingLights) ? "On" : "Off")}";
    }
